  ...
  return (
    <Container>
      <Box
        mt={3}
        sx={{
          border: '1px solid #4c4a4a', width: 846, padding: '10px 15px', borderRadius: '20px', color: '#fff',
        }}
      >
        <Box
          sx={{
          ...
          <Box px={10} sx={{ display: showComments ? 'block' : 'none' }}>
              ...
              .map((comment) => (
                ...
                >
                  <img
                    ...
                    alt="pic-profile"
                    style={{
                      borderRadius: '50%', width: '70px', height: '60px', paddingRight: '10px', paddingTop: '8px',
                    }}
                  />
                  <Box sx={{
                    display: 'flex',
            ...
            >
              <img
                src="data:image/jpeg;base64,"
                alt="pic-profile"
                style={{ borderRadius: '50%', width: '70px', paddingRight: '10px' }}
              />
              <Input
                sx={{
                  color: '#fff',
